...
class MemoWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        btn_calendar = QPushButton('월별 일정 보기')
        btn_calendar.setFont(QFont('Malgun Gothic', 10, QFont.Bold))
        btn_calendar.setStyleSheet(_btn_style)
        btn_calendar.clicked.connect(self._show_monthly_calendar)
        bottom_layout.addWidget(btn_calendar)
